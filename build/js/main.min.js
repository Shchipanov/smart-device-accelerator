...
var paragraphDiv = document.querySelector('.about__wrapper-content');
var element = document.createElement('p');
var elementText = document.createTextNode('Smart Device - это команда профессионалов. Через нас прошло более 1 000 000 клиентов, 70% из которых продолжают сотрудничество по сей день. На данный момент насчитывается более 14 офисов по всей стране и 20 городов присутствия.');
var aboutButton = document.querySelector('.about__btn');
var addText = function addText() {
  aboutButton.addEventListener('submit', function () {
    // console.log('click');
