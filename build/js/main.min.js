...
/* harmony import */ var _modules_viewport_change__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/viewport-change */ "./js/modules/viewport-change.js");
/* harmony import */ var _modules_mask_phone__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/mask-phone */ "./js/modules/mask-phone.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_viewport_change__WEBPACK_IMPORTED_MODULE_3__["viewportСhange"])();
    Object(_modules_mask_phone__WEBPACK_IMPORTED_MODULE_4__["getMaskPhone"])();
  });
...
var elementOpen = document.querySelectorAll('[data-link] > details[open]');
var elementClose = document.querySelectorAll('[data-link] > details');
function accordion() {
  function onToggle(event) {
    if (!elementOpen) {
      ...
      if (event.target.open) {
        elementOpen.forEach(function (el) {
  ...
  if (!elementClose) {
    ...
    elementClose.forEach(function (el) {
...
var openParagraph = document.querySelector('[data-about="paragraph"]');
var aboutButton = document.querySelector('[data-about="btn"]');
function addText() {
...
/*!**********************************!*\
  !*** ./js/modules/mask-phone.js ***!
  \**********************************/
/*! exports provided: getMaskPhone */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMaskPhone", function() { return getMaskPhone; });
var dataPhone = document.querySelectorAll('[data-phone]');
  ...
  if (!dataPhone) {
    ...
    [].forEach.call(dataPhone, function (input) {
      ...
      function mask(event) {
        ...
        !reg.test(this.value) ||
        // eslint-disable-next-line no-invalid-this
        this.value.length < 5 || keyCode > 47 && keyCode < 58) {
          // eslint-disable-next-line no-invalid-this
          this.value = newValue;
        }
...
/***/ "./js/modules/viewport-change.js":
/*!***************************************!*\
  !*** ./js/modules/viewport-change.js ***!
  \***************************************/
/*! exports provided: viewportСhange */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "viewportСhange", function() { return viewportСhange; });
/* harmony import */ var _accordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./accordion */ "./js/modules/accordion.js");

var detailsAll = document.querySelectorAll('[data-details]');
function viewportСhange() {
  if (!detailsAll) {
    ...
    if (viewport < 768) {
      detailsAll.forEach(function (item) {
        item.open = false;
      });
      Object(_accordion__WEBPACK_IMPORTED_MODULE_0__["accordion"])();
    } else {
      detailsAll.forEach(function (item) {
        item.open = true;
      });
