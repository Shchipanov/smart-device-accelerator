...
function accordion() {
  function onToggle(event) {
    if (event.target.open) {
      document.querySelectorAll('[data-link] > details[open]').forEach(function (el) {
  ...
  document.querySelectorAll('[data-link] > details').forEach(function (el) {
...
var detailsOne = document.querySelector('[data-details="first"]');
var detailsTwo = document.querySelector('[data-details="second"]');
